    ...
    app.controller('auction.online', ['$scope', '$routeParams', '$interval', '$window', 'http_factory',
        function ($scope, $routeParams, $interval, $window, http) {
            ...
            $scope.updatePriceOffers = function () {
                ...
                http.get('http://109.120.140.23/ServerApp/api/auction/' + $scope.model.auctionId + '/online', { params: { lotId: $scope.model.lotId } },
                    function (data) {
                        if (data != null) {
                            $scope.model.priceOffers = data;
                        } else {
            ...
            $scope.getAuction = function () {
                ...
                http.get("http://109.120.140.23/ServerApp/api/auction/" + $scope.model.auctionId, null,
