require.config({
    ...
    paths: {
        ...
        "date-format": "scripts/lib/dateformat/dist/dateformat.min",
        //alta libs

        //services
        "alta-http": "scripts/app/services/http",
        "alta-search": "scripts/app/services/search",
        //"notification": "scripts/app/services/notification",
        "alta-enum": "scripts/app/utils/altaEnum",
        ...
        "datepicker": "scripts/app/directives/datepiker",
